  ...
  return (
    <div className="max-w-md mx-auto my-16 p-8 bg-[#181512] border border-red-900/40 rounded-2xl text-center space-y-4 shadow-2xl">
      ...
      <div className="space-y-1">
        <h2 className="text-xl font-bold font-heading text-white">Admin Operations Error</h2>
        <p className="text-xs text-[#a8a095]">
          {error?.message || 'An unexpected error occurred in the admin operations dashboard.'}
        </p>
      </div>
